// 外部 JSON 文件的 URL
const CSV_PATHS_URL = 'https://raw.githubusercontent.com/mihuyazz/Random-Api/main/url.json';
...
async function handleRequest(request) {
  ...
  if (prefix in csvPaths && suffix in csvPaths[prefix]) {
    ...
    const indexHtmlResponse = await fetch('https://raw.githubusercontent.com/mihuyazz/Random-Api/main/index.html');
